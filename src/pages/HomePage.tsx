      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-slate-200 px-4 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-300 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600"
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex shrink-0 gap-1">
                    ...
                    <button
                      ...
                      className="rounded-xl bg-slate-100 p-2.5 text-slate-600 transition-colors hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-slate-600"
                    ...
                    <button
                      ...
                      className="rounded-xl bg-slate-100 p-2.5 text-red-500 transition-colors hover:bg-red-600 hover:text-white dark:bg-slate-700 dark:text-red-400"
